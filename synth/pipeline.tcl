...
set cache_module CacheCtrl
set reg_module   regfile

read_file -f ddc [list ../synth/${cache_module}.ddc]
set_dont_touch ${cache_module}
read_file -f ddc [list ../synth/${reg_module}.ddc]
set_dont_touch ${reg_module}

set headers "../sys_defs.vh"
set sources "../verilog/pipeline.v"

read_file -f sverilog [list "../sys_defs.vh" "../verilog/pipeline.v"]
